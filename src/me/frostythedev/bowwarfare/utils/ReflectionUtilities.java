...
public class ReflectionUtilities {
    ...
    public static Method getMethod(Class<?> clazz, String methodName, Class<?>... params) {
        try {
            ...
            Bukkit.getLogger().warning("No such method: " + methodName + " on class" + clazz.getCanonicalName() + "!");
        }
        return null;
    }
    ...
    public static Constructor getConstructor(Class<?> clazz, Class<?>... params) {
        try {
            ...
            Bukkit.getLogger().warning("No such constructor!");
        }
        return null;
    }
    ...
    public static <T> T invokeConstructor(Constructor constructor, Object... args) {
        try {
            ...
            Bukkit.getLogger().warning("Failed to instantiate constructor: " + constructor.getName());
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            Bukkit.getLogger().warning("Failed to access constructor: " + constructor.getName());
            e.printStackTrace();
        } catch (InvocationTargetException e) {
            Bukkit.getLogger().warning("Failed to invoke constructor: " + constructor.getName());
            e.printStackTrace();
        }
        return null;
    }
    ...
    public static void removeFinal(Field field) throws Exception {
        ...
        if (!isFinal(field)) {
            Bukkit.getLogger().warning("Field " + field.getName() + " in class " + field.getClass().getCanonicalName() + " is not final.. Cannot remove final");
            return;
        }
