...
import me.frostythedev.bowwarfare.utils.StringUtil;
...
public abstract class CommandManager<T> {
     ...
     */
    protected String getNestedUsage(String[] args, int level, Method method, T player) throws CommandException, CommandPermissionsException {
     ...
     */
    public void execute(String cmd, String[] args, T player, Object... methodArgs) throws CommandException, me.frostythedev.bowwarfare.utils.commands.CommandException {
     ...
     */
    public void execute(String[] args, T player, Object... methodArgs) throws CommandException, me.frostythedev.bowwarfare.utils.commands.CommandException {
        Object[] newMethodArgs = new Object[methodArgs.length + 1];
        System.arraycopy(methodArgs, 0, newMethodArgs, 1, methodArgs.length);
     ...
     */
    public void executeMethod(Method parent, String[] args, T player, Object[] methodArgs, int level) throws CommandException, me.frostythedev.bowwarfare.utils.commands.CommandException {
    ...
    protected void checkPermission(T player, Method method) throws CommandException, CommandPermissionsException {
        if (!hasPermission(method, player)) {
            throw new CommandPermissionsException();
        }
    }

    public void invokeMethod(Method parent, String[] args, T player, Method method, Object instance, Object[] methodArgs, int level) throws CommandException, WrappedCommandException {
        try {
